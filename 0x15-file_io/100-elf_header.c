...
/**
 * check_elf - is the file an ELF file.
 * @e_ident: Points to an array containing the ELF magic numbers.
 *
 * Description: if it isnt an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: Points to an array containing the ELF magic numbers in the file.
 *
 ...
 * @e_ident: Absolutely points to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
